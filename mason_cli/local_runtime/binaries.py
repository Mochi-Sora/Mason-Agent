...
def runtimes_root() -> Path:
    ...
    from mason_constants import get_default_mason_root

    return get_default_mason_root() / "runtimes" / "llamacpp"
...
_PLUGIN_COMPAT_LAZY = {
    'get_mason_home': ('mason_constants', 'get_mason_home'),
}
...
def __getattr__(name):  # PEP 562 — lazy so no import cycles
    ...
    import importlib
    from mason_cli.plugin_compat import warn_once
